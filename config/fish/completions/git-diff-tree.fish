...
complete -c git-diff-tree -l minimal --description 'Spend extra time to make sure the smallest po... [See Man Page]'
complete -c git-diff-tree -s W -l function-context --description 'Show whole surrounding functions of changes'
complete -c git-diff-tree -l textconv -l no-textconv --description 'Allow (or disallow) external text conversion ... [See Man Page]'
